...
function renderResults(data) {
  ...
  matchBar.innerHTML = `${matchLabels[matchType] || "🔎 Matched"}: <strong id="matched-label"></strong> &nbsp;·&nbsp; Category: <strong>${categoryLabels[category] || category}</strong>`;
  document.getElementById("matched-label").textContent = matchedProduct;
